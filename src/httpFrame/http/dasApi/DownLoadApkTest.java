...
public class DownLoadApkTest extends HttpCmd {//http接口需要继承 HttpCmd
	...
	public static String URL_NAME = "/downloadApkTest";
	static {
		//注册接口
		HttpCmd.register(URL_NAME, DownLoadApkTest.class);
	}
...
//			break;
	...
	public static void setDownLocalFile(String downLocalFileType) {
		DownLoadApkTest.downLocalFileType = downLocalFileType;
	}
	...
	public static void setFileName(String fileName) {
		DownLoadApkTest.fileName = fileName;
	}
	...
	public static void setFilePath(String filePath) {
		DownLoadApkTest.filePath = filePath;
	}
