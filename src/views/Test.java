...
//    	String st1 = "{\"DevName\":\"AAAA\",\"DevAddress\":\"172.168.1.1\",\"DevMacAddr\":\"ABCDEF\",\"DevVer\":\"333\", \"UdpPort\":3}";
//    	System.out.println(st1);
//    	DeviceInfo deviceInfo = new Gson().fromJson(st1, DeviceInfo.class);
...
//		
//		st1="{\"AA\":\"1\",\"b\":\"2\"}";
//		Tes tes = new Gson().fromJson(st1, Tes.class);
//		System.out.println(tes.a);
//    	String st="Send000000000";
...
//    	[1, true, 102BB7, 172.20.1.84, 18111, ￨ﾾﾾ￥ﾮﾞ￤﾿ﾡ￦ﾁﾯ, 1.0.4, 正在升级中]
		...
		System.out.println(vt.contains("172.20.1.84"));
    }
    
    class Tes{

    	@SerializedName(value ="A", alternate = {"a", "AA"} )
    	public String a;
    	public String b;
    }
